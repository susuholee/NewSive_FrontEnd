...
const messages = Array.from(
  new Map(
    [...history, ...realtimeMessages].map((msg) => [msg.id, msg])
  ).values()
);
            ...
            >
             ...
             <div
              className={`relative inline-block w-fit max-w-[70%] rounded-2xl px-3 py-2 ${
                  isMe ? "bg-primary text-white" : "bg-surface-muted text-text-primary"
                ...
                {isMe && !msg.isDeleted && (
               <div className="absolute right-full top-1 mr-1 flex items-center">
                <button
