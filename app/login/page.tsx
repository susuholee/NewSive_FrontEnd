...
<div className="w-full max-w-md rounded-2xl bg-surface p-7 shadow-sm translate-y-15">
      <div className="mb-6">
      ...
      >
        ...
        <button
          ...
          className="w-full rounded-lg bg-primary py-2.5 font-medium text-white transition hover:bg-primary-hover/90 disabled:opacity-50"
        >
