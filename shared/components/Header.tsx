    ...
    <>
      <header className="sticky top-0 z-50 bg-surface/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-3 sm:px-4 py-3">
          <Link
            href="/"
            className="flex items-center gap-2 text-base sm:text-lg font-bold text-primary whitespace-nowrap"
          >
          ...
          <nav
            className="
              ...
              rounded-full bg-surface-muted p-1
              text-xs sm:text-sm
              whitespace-nowrap
            "
          >
            {NAV_ITEMS.map((item) => (
              <button
                ...
                className={[
                  'rounded-full px-3 sm:px-4 py-1 sm:py-1.5 transition',
                  isActive(item.path)
          ...
          return (
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  <span className={`text-xs font-medium ${ui.textClass}`}>
                    {ui.label}
                  </span>
        ...
        >
          모든 알림 보기
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="rounded-full bg-primary px-3 sm:px-4 py-1.5 text-xs sm:text-sm text-white hover:bg-primary-hover"
                >
                  회원가입
                </Link>
              </>
